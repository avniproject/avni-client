...
describe('EncounterActionsTest', () => {
    ...
    it('validateNumericField without validation error', () => {
        ...
        var newState = ObservationsHolderActions.onPrimitiveObsEndEditing(state, {value: '1', formElement: formElement}, testContext);
    ...
    it('validateNumericField with validation error', () => {
        ...
        const newState = ObservationsHolderActions.onPrimitiveObsEndEditing(state, {value: 1000, formElement: formElement}, testContext);
        verifyFormElementAndObservations(newState, 1, 1);
    });

    it('numeric field with a string', () => {
        const {state, formElement} = createIntialState(Concept.dataType.Numeric, true, false);
        const newState = ObservationsHolderActions.onPrimitiveObsUpdateValue(state, {value: 'a', formElement: formElement}, testContext);
        ...
        const newerState = ObservationsHolderActions.onPrimitiveObsUpdateValue(newState, {value: 'a', formElement: formElement}, testContext);
    ...
    it('validateMultiSelect field when it is mandatory', () => {
        ...
        var newState = ObservationsHolderActions.toggleMultiSelectAnswer(state, {answerUUID: answerUUID, formElement: formElement}, testContext);
        verifyFormElementAndObservations(newState, 0, 1);
        verifyObservationValues(newState, 1);

        newState = ObservationsHolderActions.toggleMultiSelectAnswer(newState, {answerUUID: answerUUID2, formElement: formElement}, testContext);
        verifyFormElementAndObservations(newState, 0, 1);
        verifyObservationValues(newState, 2);

        newState = ObservationsHolderActions.toggleMultiSelectAnswer(newState, {answerUUID: answerUUID, formElement: formElement}, testContext);
        verifyFormElementAndObservations(newState, 0, 1);
        verifyObservationValues(newState, 1);
    ...
    it('scenario - 1', () => {
        ...
        var newState = ObservationsHolderActions.onPrimitiveObsUpdateValue(state, {value: '1', formElement: formElement}, testContext);
        verifyFormElementAndObservations(newState, 0, 1);

        newState = ObservationsHolderActions.toggleMultiSelectAnswer(newState, {answerUUID: answerUUID, formElement: multiSelectFormElement}, testContext);
    ...
    it('scenario - 2', () => {
        ...
        var newState = ObservationsHolderActions.onPrimitiveObsUpdateValue(state, {value: '14', formElement: formElement}, testContext);
        newState = ObservationsHolderActions.onPrimitiveObsUpdateValue(newState, {value: '10', formElement: anotherNumericFormElement}, testContext);
        expect(newState.encounter.observations.length).is.equal(2);
        newState = ObservationsHolderActions.onPrimitiveObsUpdateValue(newState, {value: '', formElement: anotherNumericFormElement}, testContext);
    ...
    it('next should not be allowed if there are validation errors in the same FEG', () => {
        const {state, formElement} = createIntialState(Concept.dataType.Numeric, true, false);
        var newState = ObservationsHolderActions.onPrimitiveObsEndEditing(state, {value: '', formElement: formElement}, testContext);
        verifyFormElementAndObservations(newState, 1, 0);
        ...
        newState = ObservationsHolderActions.onPrimitiveObsUpdateValue(state, {value: '10', formElement: formElement}, testContext);
        verifyFormElementAndObservations(newState, 0, 1);
