/*
*   Patch:
*       `ViewPropTypes` is not available in react-native-0.42.3
*       So, using its equivalent `View.propTypes`
*       Once, the original library puts a fix, get rid of this patch file.
*       Funnily this library is just one file.
*
* */
