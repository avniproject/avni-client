    ...
    enrol(programEnrolment, checklists = [], nextScheduledVisits, skipCreatingPendingStatus, groupSubjectObservations = []) {
        ...
        this.db.write(() => {
            ...
            if (!skipCreatingPendingStatus && isApprovalEnabled)
                programEnrolment.addUpdateApprovalStatus(entityApprovalStatusService.createPendingStatus(programEnrolment.uuid, ProgramEnrolment.schema.name, db, programEnrolment.program.uuid));
