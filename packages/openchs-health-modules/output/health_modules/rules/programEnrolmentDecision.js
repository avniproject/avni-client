...
var childVaccinationSchedule = __webpack_require__(6);

var getDecisions = function getDecisions(programEnrolment, today) {
    return { enrolmentDecisions: [], encounterDecisions: [] };
};

var getChecklists = function getChecklists(programEnrolment, today) {
...
var motherVisitSchedule = __webpack_require__(1);
var programDecision = __webpack_require__(7);
var c = __webpack_require__(0);
var motherVaccinationSchedule = __webpack_require__(8);
...
module.exports.getDecisions = function (enrolment, today) {
    ...
    var lmpDate = enrolment.getObservationValue('Last Menstrual Period');
    var edd = c.addDays(lmpDate, 280);
...
module.exports.validate = function (programEnrolment) {
    ...
    var gravida = programEnrolment.getObservationValue('Gravida');
    var parity = programEnrolment.getObservationValue('Parity');
    var number_of_abortion = programEnrolment.getObservationValue('Number of abortion');
...
var getVaccSchedule = function getVaccSchedule(programEnrolment) {
    var vaccScheduleItems = [];
...
module.exports = {};
module.exports.getNextScheduledVisits = __webpack_require__(1).getNextScheduledVisits;
...
var getImmunisationSchedule = function getImmunisationSchedule(programEnrolment) {
    var checklistItems = [];
    var lmpDate = programEnrolment.getObservationValue('Last Menstrual Period');
...
var ttTakenAlreadyInPreviousPregnancy = function ttTakenAlreadyInPreviousPregnancy(programEnrolment) {
    var ttInjections = programEnrolment.findObservation("TT injections taken");
...
var allImports = {};
allImports.Mother = __webpack_require__(5);
allImports.Child = __webpack_require__(4);
...
var executeProgramEnrolmentFunc = function executeProgramEnrolmentFunc(config) {
    var today = new Date();
    var programName = config.parameter.program.name;
