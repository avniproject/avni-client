    ...
    renderQuestionAnswer(answer, question, questionAnswers) {
        return (
            <View style={{flex: 1, flexDirection: 'row'}}>
                <View style={{flex: 0.5}}>
                    <Text
                        style={[DecisionView.styles.questionAnswer, DecisionView.styles.question]}>{question}</Text>
                </View>
                <View style={{flex: 0.5}}>
                    <Text style={[DecisionView.styles.questionAnswer, DecisionView.styles.answer]}>{answer}</Text>
                </View>
            </View>);
    }
        ...
        return (
            <View>
                ...
                <View style={CHSStyles.Global.mainSection}>
                    ...
                    <WizardButtons hasQuestionBefore={true} nextParams={{}} parent={this} nextView={ConclusionListView}/>
