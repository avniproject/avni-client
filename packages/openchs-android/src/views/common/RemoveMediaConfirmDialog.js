...
const styles = StyleSheet.create({
    ...
    dialog: {width: '100%', maxWidth: 320, backgroundColor: '#ffffff', borderRadius: 16, padding: 16},
    ...
    secondaryBtn: {backgroundColor: '#ffffff', borderWidth: 1, borderColor: Colors.BorderDefault, marginRight: 8},
