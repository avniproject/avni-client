    ...
    register(individual, nextScheduledVisits, skipCreatingPendingStatus, groupSubjectObservations) {
        ...
        this.db.write(() => {
            if (!skipCreatingPendingStatus && isApprovalEnabled)
                individual.addUpdateApprovalStatus(this.entityApprovalStatusService.createPendingStatus(individual.uuid, Individual.schema.name, db, individual.subjectType.uuid));
