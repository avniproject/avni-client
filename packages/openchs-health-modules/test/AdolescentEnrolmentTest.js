...
//     ProgramEnrolment
// } from "openchs-models";
// import {getDecisions} from "../health_modules/adolscent/adolescentEnrolment";
// import * as C from "../health_modules/common";
// import EntityFactory from "../../openchs-models/test/EntityFactory";
//
//
// describe("Adolescent enrolment decisions", () => {
//     let programEnrolment;
//     const adolescentVulnerabilitiesConceptName = "Adolescent Vulnerabilities";
//
//     const adolescentVulnerabilities = (decisions) => {
//         return C.findValue(decisions.enrolmentDecisions, adolescentVulnerabilitiesConceptName);
//     };
//
//     const treatmentAdvice = (decisions) => {
//         return C.findValue(decisions.enrolmentDecisions, "Treatment Advice");
//     };
//
//     beforeEach(() => {
...
//     });
//
//     it("Marks adolescent vulnerable for school dropout and addiction if no parents", () => {
//         let decisions = getDecisions(programEnrolment);
//         const vulnerabilities = adolescentVulnerabilities(decisions);
//         expect(vulnerabilities).to.not.exist;
//
//         programEnrolment = ProgramEnrolment.createEmptyInstance();
//         programEnrolment.a
//         let decisions = getDecisions(programEnrolment);
//         const vulnerabilities = adolescentVulnerabilities(decisions);
//         expect(vulnerabilities).to.exist;
//
//         expect(vulnerabilities).to.be.an('array').with.lengthOf(1).that.includes("School drop out", "Addiction");
//     });
//
...
//
//             let decisions = getDecisions(programEncounter);
//             expect(adolescentVulnerabilities(decisions)).to.be.an('array').with.lengthOf(1).that.includes("Post-Partum Haemorrhage");
//
//             otherDifficultiesObs.toggleMultiSelectAnswer(otherDifficultiesConcept.getPossibleAnswerConcept("Difficulty breathing").concept.uuid);
...
//             otherDifficultiesObs.toggleMultiSelectAnswer(otherDifficultiesConcept.getPossibleAnswerConcept("Blurred vision").concept.uuid);
//             decisions = getDecisions(programEncounter);
//             expect(adolescentVulnerabilities(decisions)).to.have.lengthOf(0);
//
...
//             decisions = getDecisions(programEncounter);
//             expect(adolescentVulnerabilities(decisions)).to.be.an('array').with.lengthOf(1).that.includes("Urinary Tract Infection");
//
//             abdominalProblemsObs.toggleMultiSelectAnswer(abdominalProblemsConcept.getPossibleAnswerConcept("Abdominal pain").concept.uuid);
...
//
//             let decisions = getDecisions(programEncounter);
//             expect(adolescentVulnerabilities(decisions)).to.be.an('array').with.lengthOf(1).that.includes("Genital Tract Infection");
//         });
//
...
//
//             let decisions = getDecisions(programEncounter);
//             expect(adolescentVulnerabilities(decisions)).to.be.an('array').with.lengthOf(1).that.includes("Mastitis");
//         });
//     });
//
...
//
//             let decisions = getDecisions(programEncounter);
//             expect(adolescentVulnerabilities(decisions)).to.be.an('array').with.lengthOf(1).that.includes("Post Operative Infection");
//         });
//     });
//
//     describe("Infection", () => {
...
//
//             let decisions = getDecisions(programEncounter);
//             expect(adolescentVulnerabilities(decisions)).to.be.an('array').with.lengthOf(1).that.includes("Infection");
//         });
//
...
//
//             let decisions = getDecisions(programEncounter);
//             expect(adolescentVulnerabilities(decisions)).to.be.an('array').with.lengthOf(1).that.includes("Post-Partum Depression");
//
//             complaintsObs.toggleMultiSelectAnswer(complaintsConcept.getPossibleAnswerConcept("Insomnia").concept.uuid);
//             decisions = getDecisions(programEncounter);
//             expect(adolescentVulnerabilities(decisions)).to.empty;
//
...
//
//             let decisions = getDecisions(programEncounter);
//             expect(adolescentVulnerabilities(decisions)).to.be.an('array').with.lengthOf(1).that.includes("Post-Partum Eclampsia");
//
//             //normal systolic,
...
//             convulsionsObs.toggleMultiSelectAnswer(convulsionsConcept.getPossibleAnswerConcept("Present").concept.uuid);
//             decisions = getDecisions(programEncounter);
//             expect(adolescentVulnerabilities(decisions)).to.be.empty;
//
