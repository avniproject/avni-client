...
_run_app: ; cd packages/openchs-android && npx react-native run-android
_run_app_release: ; cd packages/openchs-android && npx react-native run-android --variant=release
